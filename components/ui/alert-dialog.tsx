...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-black/80 supports-backdrop-filter:backdrop-blur-xs transition-opacity duration-250 ease-[var(--ease-out)] data-open:opacity-100 data-closed:opacity-0",
        className,
      )}
      {...props}
    />
