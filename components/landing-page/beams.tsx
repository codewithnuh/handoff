...
/**
 * <Beams /> — React Bits (reactbits.dev), TypeScript + Tailwind variant.
 * Animated three.js light-beam backdrop. Rendered client-side only via
 * ./hero-beams (next/dynamic, ssr:false).
 */
...
interface BeamsProps {
  ...
  beamNumber?: number;
  lightColor?: string;
  /** Directional light strength — the stock 1 is too dim on black planes */
  lightIntensity?: number;
  /** Base plane color; a near-black tint catches the light color */
  beamColor?: string;
  speed?: number;
